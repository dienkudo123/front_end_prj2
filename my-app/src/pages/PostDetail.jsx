...
export default function PostDetail() {
    ...
    const [comments, setComments] = useState([
        { id: 1, username: "user1", avatar: "https://i.pravatar.cc/50?u=user1", text: "Bài viết đẹp quá!" },
        { id: 2, username: "user2", avatar: "https://i.pravatar.cc/50?u=user2", text: "Tuyệt vời!" }
    ]);
